...
<title></title>
	...
	<div align = "center">
				...
				<input type="hidden" value="1" name="up">
					<table border="1" style="width:700px">
						...
						<input type="hidden" value="${obj.clientId}" name="id">
							<tr><td><label>出向先名称</label></td>
								<td><input type="text" name="name" value="${obj.clientName}"  style="width : 100%"></td></tr>
							<tr><td><label>電話番号</label></td>
								<td><input type="text" name="tel"  value="${obj.clientTel}" style="width : 100%"></td></tr>
							<tr><td><label>郵便番号</label></td>
								<td><input type="text" name="post" value="${obj.clientPostCode}" style="width : 100%"></td></tr>
							<tr><td><label>住所</label></td>
								<td><textarea name="add" style="width : 100%">${obj.clientAdd}</textarea></td></tr>
							<tr><td><label>最寄駅</label></td>
								<td><input type="text" name="station" value="${obj.clientNearestStation}" style="width : 100%"></td></tr>
							<tr><td><label>備考</label></td>
								<td><textarea name="remarks" style="width : 100%">${obj.clientRemarks}</textarea></td></tr>
						</c:forEach>
					</table>
			</c:if>
		...
		<a href="/spring/menu/syukkousaki_info" target="info" >
