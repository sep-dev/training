...
<body>
	<center>
		...
		<form method="POST" action="http://localhost:8080/hoge/Addressbook" name="from1">
			<br> 氏名<input type="text" name="name" size="50" value="ここに氏名を入力" /><br />
			<br> 住所<input type="text" name="address" size="50"value="ここに住所を入力" /><br />
			<br> 電話番号<input type="text"name="tel" size="50" value="ここに電話番号を入力" /><br />
