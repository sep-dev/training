...
public class Toroku-Syori extends HttpServlet {
		...
		tel1 = request.getParameter("tel");
			...
			if(name2 != "" && address2 != "" && tel2 != ""){
				...
				dispatcher.forward(request, response);
					...
					//登録失敗画面へ
					RequestDispatcher dispatcher =
					request.getRequestDispatcher("/WEB-INF/jsp/Toroku-Sippai.jsp");
					dispatcher.forward(request, response);
					System.out.print(sql);
				}
			}else{
				System.out.print(sql);
					//登録失敗画面へ
					RequestDispatcher dispatcher =request.getRequestDispatcher("/WEB-INF/jsp/Toroku-Sippai.jsp");
					dispatcher.forward(request, response);
