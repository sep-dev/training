		...
		<p><font size="5" color="red">${message}</font></p>
			...
			<table border=1>
				...
				<tr><th colspan=2>パスワード</th>
						<td><form:input path="loginuserpass1" pattern="^[0-9A-Za-z]+$"/><font color="red">※半角英数字</font></td><tr>
				<tr><th colspan=2>パスワード確認</th>
						<td><form:input path="loginuserpass2" pattern="^[0-9A-Za-z]+$"/>(もう1度入力してください)</td></tr>
			</table>
		<br>
				<input type="submit" name="userInsert2" value="登録" />　
	...
	<html>
		...
		<p><font size="5" color="red">${message}</font></p>
			...
			<table border=1>
				...
				<tr><th colspan=2>パスワード</th>
					<td><form:input path="loginuserpass1" value="${loginUserPass}" pattern="^[0-9A-Za-z]+$"/><font color="red">※半角英数字</font></td><tr>
				<tr><th colspan=2>パスワード確認</th>
					<td><form:input path="loginuserpass2"/>(もう1度入力してください)</td></tr>
			</table>
		<br>
				<input type="submit" name="userUpdate2" value="確定" />　
				<input type="button" onclick="javascript: history.back();" value="戻る">　
				<input type="reset" value="リセット" />
			</form:form>
		</div>
