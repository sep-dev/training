...
<body>
	...
	<FORM method="POST" action="http://localhost:8080/servletstudy/Addressbook" name="insertform">
		...
		電話番号 <INPUT type="text" name="tell" size="100" maxlength="11"value="08042877369" style="color:#999"><br>

		<INPUT type="submit" value="登録">
		<INPUT type="reset" value="リセット">
		<INPUT type="button"value="一覧表示" onclick="location.href='http://localhost:8080/servletstudy/Addressbook'">
