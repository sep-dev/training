...
<body>
	...
	<form action="DataAdd" method="post">
		...
		電話番号：<input type="tel" name="tel" value="" placeholder="電話番号を入力してください" maxlength="10" size="50" onkeyDown="return numOnly()" required><br><br>
		<button type="submit" name="touroku" value="登録">登録</button>
