...
<title>派遣先編集</title>
	...
	<body>
	<h1>メインメニュー</h1>
	<form action="/hakensaki" method="GET">
	派遣先情報
	</form>
	<div align="center">
	<form:form modelAttribute="FormModel" action="./update" >
		<table border="1" width="650px" height="300px">
			...
			<tr>
				...
				<td>条件</td>
				<td align="center"><form:input type="number" path="zyouken" maxlength="255" size="25"/></td>
			</tr>
			<tr>
				<td>控除単価</td>
			...
			<tr>
				<td colspan="1">サイト</td>
				<th colspan="3"><form:input type="text" path="saite" maxlength="255" size="70" /></th>
			</tr>
			<tr>
				<td>開始日</td>
